...
from .sport_api import (
    ...
    ROBOT_SPORT_API_ID_BODYHEIGHT,
    ROBOT_SPORT_API_ID_CLASSICWALK,
    ROBOT_SPORT_API_ID_CONTINUOUSGAIT,
    ROBOT_SPORT_API_ID_DAMP,
    ROBOT_SPORT_API_ID_FASTWALK,
    ROBOT_SPORT_API_ID_FREEEULER,
    ROBOT_SPORT_API_ID_FREEWALK,
    ROBOT_SPORT_API_ID_HANDSTAND,
    ROBOT_SPORT_API_ID_MOVE,
    ROBOT_SPORT_API_ID_MOVETOPOS,
    ...
    ROBOT_SPORT_API_ID_SWITCHGAIT,
    ROBOT_SPORT_API_ID_SWITCHMOVEMODE,
    ROBOT_SPORT_API_ID_TRAJECTORYFOLLOW,
    ROBOT_SPORT_API_ID_VISIONWALK,
    SPORT_API_VERSION,
    SPORT_ERR_CLIENT_POINT_PATH,
    SPORT_SERVICE_NAME,
)
...
class SportClient(Client):
    ...
    def BalanceStand(self):
        p = {}
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_BALANCESTAND, parameter)
        return code

    def StopMove(self):
        p = {}
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_STOPMOVE, parameter)
        return code

    def StandUp(self):
        p = {}
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_STANDUP, parameter)
        return code

    def StandDown(self):
        p = {}
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_STANDDOWN, parameter)
        return code

    def RecoveryStand(self):
        p = {}
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_RECOVERYSTAND, parameter)
        return code
    ...
    def SwitchGait(self, t: int):
        ...
        p["data"] = t
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_SWITCHGAIT, parameter)
        return code
    ...
    def BodyHeight(self, height: float):
        ...
        p["data"] = height
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_BODYHEIGHT, parameter)
        return code
    ...
    def SpeedLevel(self, level: int):
        ...
        p["data"] = level
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_SPEEDLEVEL, parameter)
        return code

    def TrajectoryFollow(self, path: list):
        len_path = len(path)
        if len_path != SPORT_PATH_POINT_SIZE:
    ...
    def ContinuousGait(self, flag: int):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_CONTINUOUSGAIT, parameter)
        return code
    ...
    def MoveToPos(self, x: float, y: float, yaw: float):
        ...
        p["yaw"] = yaw
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_MOVETOPOS, parameter)
        return code
    ...
    def SwitchMoveMode(self, flag: bool):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_SWITCHMOVEMODE, parameter)
        return code
    ...
    def VisionWalk(self, flag: bool):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_VISIONWALK, parameter)
        return code
    ...
    def HandStand(self, flag: int):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_HANDSTAND, parameter)
        return code
    ...
    def AutoRecoverySet(self, flag: int):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_AUTORECOVERY_SET, parameter)
        return code
    ...
    def FreeWalk(self):
        ...
        p["data"] = True  ## default
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_FREEWALK, parameter)
        return code
    ...
    def ClassicWalk(self, flag: bool):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_CLASSICWALK, parameter)
        return code
    ...
    def FastWalk(self, flag: bool):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_FASTWALK, parameter)
        return code
    ...
    def FreeEuler(self, flag: bool):
        ...
        p["data"] = flag
        parameter = json.dumps(p)
        code, _ = self._Call(ROBOT_SPORT_API_ID_FREEEULER, parameter)
        return code
